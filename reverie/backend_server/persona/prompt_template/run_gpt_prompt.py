...
from persona.prompt_template.chain_utils import (
    # P0
    run_gpt_prompt_event_poignancy_v2,
    run_gpt_prompt_thought_poignancy_v2,
    run_gpt_prompt_chat_poignancy_v2,
    run_gpt_prompt_pronunciatio_v2,
    run_gpt_prompt_event_triple_v2,
    # P1 planning
    run_gpt_prompt_wake_up_hour_v2,
    run_gpt_prompt_daily_plan_v2,
    # Batch A
    run_gpt_prompt_summarize_conversation_v2,
    run_gpt_prompt_keyword_to_thoughts_v2,
    run_gpt_prompt_agent_chat_summarize_ideas_v2,
    run_gpt_prompt_agent_chat_summarize_relationship_v2,
    run_gpt_prompt_summarize_ideas_v2,
    run_gpt_prompt_generate_next_convo_line_v2,
    run_gpt_prompt_generate_whisper_inner_thought_v2,
    run_gpt_prompt_planning_thought_on_convo_v2,
    run_gpt_prompt_memo_on_convo_v2,
    run_gpt_prompt_act_obj_desc_v2,
    # Batch B
    run_gpt_prompt_act_obj_event_triple_v2,
    run_gpt_prompt_focal_pt_v2,
    run_gpt_prompt_insight_and_guidance_v2,
    run_gpt_prompt_extract_keywords_v2,
    run_gpt_prompt_convo_to_thoughts_v2,
    run_gpt_generate_safety_score_v2,
    run_gpt_prompt_generate_hourly_schedule_v2,
    # Batch C
    ...
    run_gpt_prompt_decide_to_talk_v2,
    run_gpt_prompt_decide_to_react_v2,
    run_gpt_prompt_create_conversation_v2,
    run_gpt_prompt_agent_chat_v2,
    run_gpt_generate_iterative_chat_utt_v2,
)

# Phase 2 migration: point old names to LangChain-based v2 implementations
run_gpt_prompt_event_poignancy = run_gpt_prompt_event_poignancy_v2
run_gpt_prompt_thought_poignancy = run_gpt_prompt_thought_poignancy_v2
run_gpt_prompt_chat_poignancy = run_gpt_prompt_chat_poignancy_v2
run_gpt_prompt_pronunciatio = run_gpt_prompt_pronunciatio_v2
run_gpt_prompt_event_triple = run_gpt_prompt_event_triple_v2
run_gpt_prompt_wake_up_hour = run_gpt_prompt_wake_up_hour_v2
run_gpt_prompt_daily_plan = run_gpt_prompt_daily_plan_v2
run_gpt_prompt_summarize_conversation = run_gpt_prompt_summarize_conversation_v2
run_gpt_prompt_keyword_to_thoughts = run_gpt_prompt_keyword_to_thoughts_v2
run_gpt_prompt_agent_chat_summarize_ideas = run_gpt_prompt_agent_chat_summarize_ideas_v2
run_gpt_prompt_agent_chat_summarize_relationship = run_gpt_prompt_agent_chat_summarize_relationship_v2
run_gpt_prompt_summarize_ideas = run_gpt_prompt_summarize_ideas_v2
run_gpt_prompt_generate_next_convo_line = run_gpt_prompt_generate_next_convo_line_v2
run_gpt_prompt_generate_whisper_inner_thought = run_gpt_prompt_generate_whisper_inner_thought_v2
run_gpt_prompt_planning_thought_on_convo = run_gpt_prompt_planning_thought_on_convo_v2
run_gpt_prompt_memo_on_convo = run_gpt_prompt_memo_on_convo_v2
run_gpt_prompt_act_obj_desc = run_gpt_prompt_act_obj_desc_v2
run_gpt_prompt_act_obj_event_triple = run_gpt_prompt_act_obj_event_triple_v2
run_gpt_prompt_focal_pt = run_gpt_prompt_focal_pt_v2
run_gpt_prompt_insight_and_guidance = run_gpt_prompt_insight_and_guidance_v2
run_gpt_prompt_extract_keywords = run_gpt_prompt_extract_keywords_v2
run_gpt_prompt_convo_to_thoughts = run_gpt_prompt_convo_to_thoughts_v2
run_gpt_generate_safety_score = run_gpt_generate_safety_score_v2
run_gpt_prompt_generate_hourly_schedule = run_gpt_prompt_generate_hourly_schedule_v2
run_gpt_prompt_task_decomp = run_gpt_prompt_task_decomp_v2
run_gpt_prompt_action_sector = run_gpt_prompt_action_sector_v2
run_gpt_prompt_action_arena = run_gpt_prompt_action_arena_v2
run_gpt_prompt_action_game_object = run_gpt_prompt_action_game_object_v2
run_gpt_prompt_new_decomp_schedule = run_gpt_prompt_new_decomp_schedule_v2
run_gpt_prompt_decide_to_talk = run_gpt_prompt_decide_to_talk_v2
run_gpt_prompt_decide_to_react = run_gpt_prompt_decide_to_react_v2
run_gpt_prompt_create_conversation = run_gpt_prompt_create_conversation_v2
run_gpt_prompt_agent_chat = run_gpt_prompt_agent_chat_v2
run_gpt_generate_iterative_chat_utt = run_gpt_generate_iterative_chat_utt_v2
...
def _run_gpt_prompt_wake_up_hour_legacy(persona, test_input=None, verbose=False): 
  """
...
def _run_gpt_prompt_daily_plan_legacy(persona, 
                              wake_up_hour, 
                              test_input=None, 
                              verbose=False):
  """
...
def _run_gpt_prompt_generate_hourly_schedule_legacy(persona, 
                                            curr_hour_str,
                                            p_f_ds_hourly_org, 
                                            hour_str,
                                            intermission2=None,
...
def _run_gpt_prompt_task_decomp_legacy(persona, 
                               task, 
                               duration, 
                               test_input=None, 
                               verbose=False): 
...
def _run_gpt_prompt_action_sector_legacy(action_description, 
                                persona, 
                                maze, 
                                test_input=None, 
                                verbose=False):
...
def _run_gpt_prompt_action_arena_legacy(action_description, 
                                persona, 
...
def _run_gpt_prompt_action_game_object_legacy(action_description, 
                                      persona, 
                                      maze,
                                      temp_address,
                                      test_input=None, 
...
def _run_gpt_prompt_pronunciatio_legacy(action_description, persona, verbose=False): 
  def create_prompt_input(action_description): 
    if "(" in action_description: 
...
def _run_gpt_prompt_event_triple_legacy(action_description, persona, verbose=False): 
...
def _run_gpt_prompt_act_obj_desc_legacy(act_game_object, act_desp, persona, verbose=False): 
...
def _run_gpt_prompt_act_obj_event_triple_legacy(act_game_object, act_obj_desc, persona, verbose=False): 
...
def _run_gpt_prompt_new_decomp_schedule_legacy(persona, 
                                       main_act_dur, 
                                       truncated_act_dur, 
                                       start_time_hour,
                                       end_time_hour, 
...
def _run_gpt_prompt_decide_to_talk_legacy(persona, target_persona, retrieved,test_input=None, 
                                       verbose=False): 
...
def _run_gpt_prompt_decide_to_react_legacy(persona, target_persona, retrieved,test_input=None, 
                                       verbose=False): 
  def create_prompt_input(init_persona, target_persona, retrieved, 
                          test_input=None): 
...
def _run_gpt_prompt_create_conversation_legacy(persona, target_persona, curr_loc,
...
def _run_gpt_prompt_summarize_conversation_legacy(persona, conversation, test_input=None, verbose=False): 
...
def _run_gpt_prompt_extract_keywords_legacy(persona, description, test_input=None, verbose=False): 
...
def _run_gpt_prompt_keyword_to_thoughts_legacy(persona, keyword, concept_summary, test_input=None, verbose=False): 
...
def _run_gpt_prompt_convo_to_thoughts_legacy(persona, 
                                    init_persona_name,  
                                    target_persona_name,
                                    convo_str,
...
def _run_gpt_prompt_event_poignancy_legacy(persona, event_description, test_input=None, verbose=False): 
...
def _run_gpt_prompt_thought_poignancy_legacy(persona, event_description, test_input=None, verbose=False): 
  def create_prompt_input(persona, event_description, test_input=None): 
    prompt_input = [persona.scratch.name,
                    persona.scratch.get_str_iss(),
                    persona.scratch.name,
...
def _run_gpt_prompt_chat_poignancy_legacy(persona, event_description, test_input=None, verbose=False): 
  def create_prompt_input(persona, event_description, test_input=None): 
    prompt_input = [persona.scratch.name,
                    persona.scratch.get_str_iss(),
                    persona.scratch.name,
...
def _run_gpt_prompt_focal_pt_legacy(persona, statements, n, test_input=None, verbose=False): 
...
def _run_gpt_prompt_insight_and_guidance_legacy(persona, statements, n, test_input=None, verbose=False): 
  def create_prompt_input(persona, statements, n, test_input=None): 
    prompt_input = [statements, str(n)]
    return prompt_input
...
def _run_gpt_prompt_agent_chat_summarize_ideas_legacy(persona, target_persona, statements, curr_context, test_input=None, verbose=False): 
...
def _run_gpt_prompt_agent_chat_summarize_relationship_legacy(persona, target_persona, statements, test_input=None, verbose=False): 
...
def _run_gpt_prompt_agent_chat_legacy(maze, persona, target_persona,
                               curr_context, 
                               init_summ_idea, 
...
def _run_gpt_prompt_summarize_ideas_legacy(persona, statements, question, test_input=None, verbose=False): 
...
def _run_gpt_prompt_generate_next_convo_line_legacy(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None, verbose=False): 
...
def _run_gpt_prompt_generate_whisper_inner_thought_legacy(persona, whisper, test_input=None, verbose=False): 
...
def _run_gpt_prompt_planning_thought_on_convo_legacy(persona, all_utt, test_input=None, verbose=False): 
...
def _run_gpt_prompt_memo_on_convo_legacy(persona, all_utt, test_input=None, verbose=False): 
  def create_prompt_input(persona, all_utt, test_input=None): 
    prompt_input = [all_utt, persona.scratch.name, persona.scratch.name, persona.scratch.name]
    return prompt_input
...
def _run_gpt_generate_safety_score_legacy(persona, comment, test_input=None, verbose=False): 
...
def _run_gpt_generate_iterative_chat_utt_legacy(maze, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None, verbose=False): 
